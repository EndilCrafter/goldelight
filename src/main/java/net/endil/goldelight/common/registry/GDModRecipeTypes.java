...
public class GDModRecipeTypes {
    ...
    public static final RegistryObject<RecipeType<GoldenCuttingBoardRecipe>> GOLDEN_CUTTING = RECIPE_TYPES.register("golden_cutting",
            () -> registerRecipeType("golden_cutting"));
